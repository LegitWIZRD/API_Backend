This is the beginnings of a backend api. The docker file is setup to run a container with an endpoint of "127.0.0.1:9999" on the local machine and has 3 endpoints:
